...
public class loadingPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        num.setText("%");
        getContentPane().add(num, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 350, -1, -1));
        getContentPane().add(bar, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 340, 230, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/load_bg.jpeg"))); // NOI18N
